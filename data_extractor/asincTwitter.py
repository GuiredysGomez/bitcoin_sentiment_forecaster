...
año_objetivo = 2023 # Año en que se realizará la busqueda
USER = 'DylanLeClair_' # usuario al que se realizará la busqueda
CSV_FILENAME = 'tweets_news.csv' # .csv donde se guardaran los tweets
